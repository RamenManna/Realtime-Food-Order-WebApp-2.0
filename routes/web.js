...
const profileControllera = require("../app/http/controllers/admin/profileController");
...
function initRoutes(app) {
  ...
  app.get("/admin/profile/", admin, profileControllera().index);
  app.post("/admin/profile/", admin, profileControllera().updateProfileInfo);
