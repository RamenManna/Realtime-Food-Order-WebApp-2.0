...
var cancelBtn = document.querySelector(".cta_cancel");
var editProfileInfo = document.getElementById("edit-profile-info");
var inputBlocked = document.querySelectorAll(".input-blocked");
var profileInfoSubmitBtn = document.querySelector(".submit_profile_info");
var hideProfileBlock = document.querySelector("#hide-profile-block");
var genderSpanBlock = document.querySelectorAll(".gender-block span");
var editAddress = document.getElementsByClassName("edit-address");
...
if (editProfileInfo) {
  editProfileInfo.addEventListener("click", function (e) {
    ...
    profileInfoSubmitBtn.style.display = "block";
    hideProfileBlock.style.display = "block"; // All input field remove disabled attribute

    inputBlocked.forEach(function (e) {
      e.classList.remove("disabled");
      e.removeAttribute("disabled");
    }); // Gender span block remove disabled class

    genderSpanBlock.forEach(function (e) {
...
if (hideProfileBlock) {
  hideProfileBlock.addEventListener("click", function (e) {
    profileInfoSubmitBtn.style.display = "none";
    editProfileInfo.style.display = "initial";
    hideProfileBlock.style.display = "none"; // All input field show disabled attribute
...
var minusBtn = document.getElementsByClassName("quantity__minus");
var plusBtn = document.getElementsByClassName("quantity__plus"); // const quantityInput = document.getElementsByClassName("quantity__input");
...
var removeItem = document.getElementsByClassName("delete-cart-item");
...
var dropdown = document.getElementById("options-menu"); // navbar dropdown open with click
...
var dropdownEdit = document.getElementsByClassName("dropdown-edit");

var _loop = function _loop(_i) {
  editAddress[_i].addEventListener("mouseover", function () {
    dropdownEdit[_i].style.display = "block";
  });
};

for (var _i = 0; _i < editAddress.length; _i++) {
  _loop(_i);
}

var _loop2 = function _loop2(j) {
  dropdownEdit[j].addEventListener("mouseleave", function () {
    dropdownEdit[j].style.display = "none";
  });
};

for (var j = 0; j < dropdownEdit.length; j++) {
  _loop2(j);
} // navbar icon open/close toggle


var toggleIcon = document.getElementById("toggle-open");
...
function _initStripe() {
  _initStripe = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2() {
    var stripe, card, mountWidget, paymentType, paymentTypePatym, paymentTypeGpay, paymentTypeAmazonPay, paymentTypeCod, paymentTypeRazorpay, paymentForm;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            _context2.next = 3;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)("pk_test_51Hon0HHBbqoWJa8GIWctzN1alZZmf5ywkRLpizX9trUoaa4SWfUY9349RSvcSLQk1k6dLzOjUy6DrXNGeRkVRqKO000MkdcsAH");

          case 3:
            stripe = _context2.sent;
            card = null;
            paymentType = document.querySelector("#stripe");
            paymentTypePatym = document.querySelector("#paytm");
            paymentTypeGpay = document.querySelector("#gPay");
            paymentTypeAmazonPay = document.querySelector("#amazonPay");
            paymentTypeCod = document.querySelector("#cod");
            paymentTypeRazorpay = document.querySelector("#razorpay");
          ...
          case 13:
            ...
            paymentTypeCod.addEventListener("click", function (e) {
            ...
            paymentTypePatym.addEventListener("click", function (e) {
            ...
            paymentTypeGpay.addEventListener("click", function (e) {
            ...
            paymentTypeAmazonPay.addEventListener("click", function (e) {
            ...
            paymentTypeRazorpay.addEventListener("click", function (e) {
